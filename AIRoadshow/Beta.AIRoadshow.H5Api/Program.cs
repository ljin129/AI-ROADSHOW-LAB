...
namespace Beta.AIRoadshow.H5Api;
...
public class Program : Starter.WebStartup
{
    ...
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services
            .AddCors(options => options.AddPolicy("Beta.AIRoadshow.H5Api.Cors", x => x.AllowAnyMethod().AllowAnyHeader().WithExposedHeaders("bjwt").SetIsOriginAllowed(_ => true).AllowCredentials()));
        ...
        services.AddHostedService<PracticeRatingBackgroundService>();
    }
    ...
    {
        app
            .UseCors("Beta.AIRoadshow.H5Api.Cors");
        app
            .UseRouting()
            .UseAuthentication()
            .UseAuthorization()
