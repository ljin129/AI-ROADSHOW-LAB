...
namespace Beta.AIRoadshow.Service;

/// <summary>
/// 
/// </summary>
public class Program : Starter.ServiceStartup
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IHostEnvironment environment)
    {
        app
            .UseRouting()
            .UseAutoMapper()
            //.UseEndpoints(endpoints => endpoints.RegisterGrpcServer())
            ;
    }
